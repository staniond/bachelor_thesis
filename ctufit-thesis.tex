...
\begin{acknowledgmentpage}
    First and foremost, I would like to thank my supervisor Ing.\,Jiří Buček,\,Ph.D. for his guidance, inspiring advice and consultations.
    Next, I would like to express my gratitude towards my family which has always supported me, not only in my studies but in everything I do.
    Finally, my thanks also belong to all of my friends who helped me with my studies tremendously. I would like to specifically name Terezie Hrubanová and Petr Šejvl.
...
\include{text/puf}
\include{text/sram_puf}
\include{text/esp32}
\include{text/puf_implementation}
\include{text/response_regeneration}
\include{text/puflib}
