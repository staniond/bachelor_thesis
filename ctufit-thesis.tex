...
\ctufitabstractENG{
    ...
    Two power-control methods of \gls{sram} memory on the ESP32 are proposed. An analysis of behavior of startup \gls{sram} bit values depending on operating temperature is conducted for both methods. Their suitability for the \gls{puf} implementation is discussed based on the experimental results.
