...
A lot of different \gls{puf} implementations have been proposed. They can be classified based on fabrication, security and intrinsic evaluation.\cite{Shital2017}\cite{McGrath2019}
...
\gls{sram} and arbiter \glspl{puf} are examples of intrinsic \glspl{puf}. If the \gls{puf} construction does not satisfy the given properties, it is called non-instrisic. For example optical or coating \glspl{puf} are non-intrinsic.\cite{Maes2012}
