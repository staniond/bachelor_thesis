...
Focus will be put on cryptographic key generation as it is the typical application of weak \glspl{puf} and the \gls{sram} \gls{puf} implemented in this thesis is classified as weak\cite{Herder2014}.
...
% TODO tady by mel byt ECC a vysvetleni reseni nestability pufu
% TODO napsat ze z key muzeme udelat autentizaci existujici kryptografii viz ... A tutorial
